...
public class LevelEventPacket extends DataPacket {
    ...
    public static final int EVENT_DEATH_SMOKE = 2007;
    public static final int EVENT_PARTICLE_BLOCK_FORCE_FIELD = 2008;
    public static final int EVENT_GENERIC_SPAWN = 2009;
    public static final int EVENT_DRAGON_EGG = 2010;
    public static final int EVENT_PARTICLES_CROP_EATEN = 2011;
    public static final int EVENT_PARTICLES_CRIT = 2012;
    public static final int EVENT_PARTICLES_TELEPORT = 2013;
    public static final int EVENT_PARTICLE_PUNCH_BLOCK = 2014;
    public static final int EVENT_PARTICLE_BUBBLE = 2015;
